...
(doom! :input
       ...
       ;; gist              ; interacting with github gists ;; this fails to locate
       ...
       (org +roam2 +pretty +pandoc +gnuplot +dragndrop +jupyter +noter +crypt +pomodoro)   ; organize your plain life in plain text
       ...
       ;;; have to temporarily disable rust
