# Initially generated by imperative settings then nix run github:pjones/plasma-manager.
# Modify settings declaratively by editing this file.
{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-449e1a97-246f-40d2-8003-2a6dca448cf2" = [ ];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."449e1a97-246f-40d2-8003-2a6dca448cf2" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "449e1a97-246f-40d2-8003-2a6dca448cf2";
      ...
      "kgammarc"."Screen 0"."bgamma" = 1.20;
      "kgammarc"."Screen 0"."ggamma" = 1.20;
      "kgammarc"."Screen 0"."rgamma" = 1.20;
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{a8e6f75d-9b6a-4969-bcc5-497ca3d6da3f}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{3d938201-aeff-449a-b0e1-185c5ae78d4d}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{fbdc7a5d-1fbc-4f3b-b758-6a314023304f}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{ce8377ba-8111-4d4b-bb02-1cc3276e697c}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{fb267374-e1ba-4952-aea5-0b67caa58bcb}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{1f2e7656-c3bb-4f90-98ce-cb400b52ee50}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{1f63fc46-95b1-42cf-a564-92b93137d9f6}";
      ...
      "kscreenlockerrc"."Daemon"."Timeout" = 11;
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."Image" = "/home/qd/projects/declare/modules/system/desktops/backgrounds/grittea.jpg";
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."PreviewImage" = "/home/qd/projects/declare/modules/system/desktops/backgrounds/grittea.jpg";
      "kwalletrc"."Wallet"."First Use" = false;
      "kwinrc"."Compositing"."LatencyPolicy" = "Medium";
      "kwinrc"."Desktops"."Id_1" = "ec5dea06-fcbf-4af4-9a0c-40b9851a71bd";
      "kwinrc"."Desktops"."Id_2" = "629327bb-d80b-4485-80b2-9eab8f65d865";
      "kwinrc"."Desktops"."Id_3" = "03f35050-8e9d-4653-90cd-74ee03c6caf0";
      "kwinrc"."Desktops"."Id_4" = "3175d22b-7070-4655-b27b-0c7246afa619";
      "kwinrc"."Desktops"."Name_1" = "Efficient";
      "kwinrc"."Desktops"."Name_2" = "Market";
      "kwinrc"."Desktops"."Name_3" = "Hypothesis";
      "kwinrc"."Desktops"."Name_4" = "Amen";
      ...
      "kwinrc"."Tiling.30eaa84c-6b73-50ac-b398-c2a07db56d2e"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.331266cd-eb00-5e1a-b1cb-8ce724dcbe70"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Windows"."RollOverDesktops" = true;
      "kwinrulesrc"."1"."Description" = "block compositing";
      "kwinrulesrc"."1"."blockcompositing" = true;
      "kwinrulesrc"."1"."blockcompositingrule" = 2;
      "kwinrulesrc"."1"."wmclassmatch" = 1;
      "kwinrulesrc"."8e3cc8d5-c54f-4793-98e0-fb5f5f696483"."Description" = "block compositing";
      "kwinrulesrc"."8e3cc8d5-c54f-4793-98e0-fb5f5f696483"."blockcompositing" = true;
      "kwinrulesrc"."8e3cc8d5-c54f-4793-98e0-fb5f5f696483"."blockcompositingrule" = 2;
      "kwinrulesrc"."8e3cc8d5-c54f-4793-98e0-fb5f5f696483"."wmclassmatch" = 1;
      "kwinrulesrc"."General"."count" = 1;
      "kwinrulesrc"."General"."rules" = 1;
      "kwinrulesrc"."b047652b-39d8-47b0-b5c0-09a98bfba912"."Description" = "Application settings for wowclassic.exe";
      "kwinrulesrc"."b047652b-39d8-47b0-b5c0-09a98bfba912"."clientmachine" = "localhost";
      "kwinrulesrc"."b047652b-39d8-47b0-b5c0-09a98bfba912"."wmclass" = "wowclassic.exe";
      "kwinrulesrc"."b047652b-39d8-47b0-b5c0-09a98bfba912"."wmclassmatch" = 1;
      "plasma-localerc"."Formats"."LANG" = "en_US.utf8";
      "plasmarc"."Theme"."name" = "oxygen";
      "plasmarc"."Wallpapers"."usersWallpapers" = "/home/qd/projects/declare/modules/system/desktops/backgrounds/grittea.jpg,/home/qd/projects/declare/modules/system/desktops/backgrounds/phaesp.jpg";
    };
  };
}
