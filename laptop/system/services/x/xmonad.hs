...
keybinds = [ ((modShift, xK_z), spawn "xscreensaver-command -lock")
    ...
    , ((modShift, xK_h), spawnHere "blueman-manager & pavucontrol")
    , ((modShift, xK_g), spawnHere "firefox --new-window \"chat.openai.com/chat?model=gpt-4\"")
    , ((modShift, xK_p), spawnOn "6" "bitwarden")
